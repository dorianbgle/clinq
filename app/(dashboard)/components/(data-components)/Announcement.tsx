...
const Announcement = async () => {
  ...
  return (
    <Sheet>
      <SheetTrigger>
        <div className="rounded-full items-center justify-center border hover:bg-blue-900/40 p-1 hover:text-blue-500 hover:border-blue-500 border-zinc-700 text-zinc-700">
