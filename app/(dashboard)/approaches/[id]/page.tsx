          ...
          {symptoms &&
            symptoms.map((i: any) => (
              <>
                ...
                {i?.investigationjson?.some(
                  (d: any) => d?.investigation && d?.description
                ) ||
                i?.specificinvestigationjson?.some(
                  (d: any) => d?.investigation && d?.description
                ) ? (
                  <Accordion type="single" collapsible>
                    <AccordionItem value="item-1">
                          ...
                          <section className="col-span-1">
                            ...
                            <div className="grid grid-cols-3">
                              {i?.specificinvestigationjson?.some(
                                ...
                                i?.specificinvestigationjson.map(
                                  (d: any, index: any) =>
                                    d?.investigation && d?.description ? (
                                      <div key={index}>
                                        <div className="col-span-1 border p-3 uppercase font-semibold">
                    ...
                    <AccordionContent>
                      <>
                        <section className="p-5 w-full bg-green-800/20 border border-green-800 rounded-xl text-green-800 mb-3">
                          <h1>
                            Reviewed by <strong>Dorian Le</strong>
                          </h1>
                          <>
                            {i?.symptomjson?.comments ? (
                              <div>
                                <Markdown>{i.symptomjson?.comments}</Markdown>
                              </div>
                            ) : (
                              <p className="flex justify-center text-xl">
                                &quot;Review yet to be completed&quot;
                              </p>
                            )}
                          </>
                        </section>
