      ...
      <div className="container">
        <div className="min-h-[950px]">
          ...
          <div className="flex items-center flex-col text-center relative">
            ...
            <p className="text-xl mt-4">Claim $350 p.a deal</p>
          ...
          <div className="-mt-[200px] ">
            ...
            <Accordion type="single" collapsible className="w-full mt-10 mb-48">
              <AccordionItem value="item-1">
                <AccordionTrigger>
                  What are ClinQ&apos;s missions and core values?
                </AccordionTrigger>
                <AccordionContent>
              ...
              <AccordionItem value="item-2">
                <AccordionTrigger>
                  ...
                  Does ClinQ provide discounts for group purchases?
                  </span>
                </AccordionTrigger>
                <AccordionContent>
              ...
              <AccordionItem value="item-3">
                <AccordionTrigger>What is the process for submitting a feature request to ClinQ?</AccordionTrigger>
                <AccordionContent>
                  Yes. We are currently writing documentation for this. You can
                  find the repository .
                </AccordionContent>
              ...
              <AccordionItem value="item-4">
                <AccordionTrigger>
                  What resources are used in the development of ClinQ?
                </AccordionTrigger>
                <AccordionContent>
              ...
              <AccordionItem value="item-7">
                ...
                <AccordionContent>
                  Sure, we&apos;re happy to answer any questions you might have.
                  Just send us an email at{" "}
                  <a href="mailto:support@midday.ai">support@mclinq.io</a> and
              ...
              <AccordionItem value="item-8">
                <AccordionTrigger>
                  <span className="truncate">
                    I have more questions about ClinQ. How can I get in touch?
                  </span>
                </AccordionTrigger>
                <AccordionContent>
                  Absolutely. We are currently writing the documentation for
