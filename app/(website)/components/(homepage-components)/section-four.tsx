...
export function SectionFour() {
  return (
    <section className="flex justify-between space-y-12 md:space-y-0 md:space-x-8 flex-col md:flex-row overflow-hidden mb-12">
      <div className="border border-border basis-1/3 bg-zinc-950 p-10 md:text-center flex flex-col" id="simulations">
      ...
      <div className="border border-border md:basis-2/3 bg-zinc-950 p-10 flex justify-between md:space-x-8 md:flex-row flex-col" id="cases">
